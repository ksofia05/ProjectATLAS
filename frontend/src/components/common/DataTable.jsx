                  ...
                  <thead>
                    <tr>
                      {columns.map((col, idx) => (
                        <th
                          key={idx}
                          className="py-2 sm:py-3 px-2 sm:px-3 md:px-4 font-bold text-gray-200 text-xs sm:text-sm uppercase tracking-wide"
                        >
                          {col.label}
                        </th>
                      ))}
                    ...
                    {filteredData.map((item, idx) => (
                      ...
                      >
                        {columns.map((col, colIdx) => (
                          <td key={colIdx} className="py-2 px-2 sm:px-3 md:px-4 text-xs sm:text-sm">
