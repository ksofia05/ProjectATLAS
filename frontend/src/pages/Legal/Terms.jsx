  ...
  const content = (
    <>
      ...
      <div className="bg-[#171722] border border-slate-800/40 rounded-2xl p-6 text-gray-300 text-base space-y-6 shadow-lg">
        <h2 className="text-xl font-bold text-white mb-2">• Introducción</h2>
        <p>
          Bienvenido a ATLAS COMPANY. Estos Términos y Condiciones regulan el
          uso de nuestro software de gestión de inventario en línea, diseñado
        ...
        <h2 className="text-xl font-bold text-white mb-2">• Uso aceptable</h2>
        <p>
