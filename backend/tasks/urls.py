...
from tasks.views import login_usuario, registe_usuario, recuperacion_contra, password_reset, invitacion_colaborador, verificar_correo_existente, quitar_colaborador_de_proyecto, tareas_por_proyecto_usuario, debug_tareas
...
urlpatterns = [
    ...
    path('api/v1/tareas_por_proyecto_usuario/', tareas_por_proyecto_usuario, name='tareas_por_proyecto_usuario'),
    path('api/v1/debug_tareas/', debug_tareas, name='debug_tareas'),
]